        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-(--surface) border border-(--border) rounded-xl p-5">
              ...
              <p className="text-(--text-primary) font-medium">Chas Academy — Fullstack Developer</p>
              <p className="text-(--text-muted) text-sm">Sep 2025 – Jun 2027 · Stockholm</p>
            </div>

            <div className="bg-(--surface) border border-(--border) rounded-xl p-5">
              <p className="text-green-400 text-sm font-semibold mb-1">Cybersecurity</p>
              <p className="text-(--text-primary) font-medium">Cybersäkerhet för yrkesverksamma</p>
              <p className="text-(--text-muted) text-sm">Dec 2025 – Jan 2026 · 25 YH Points</p>
            </div>

            <div className="bg-(--surface) border border-(--border) rounded-xl p-5">
              <p className="text-green-400 text-sm font-semibold mb-1">Location</p>
              <p className="text-(--text-primary) font-medium">Stockholm, Sweden</p>
              <p className="text-(--text-muted) text-sm">Open to hybrid & remote LIA</p>
            </div>

            <div className="bg-(--surface) border border-(--border) rounded-xl p-5">
              <p className="text-green-400 text-sm font-semibold mb-1">Languages</p>
              <p className="text-(--text-primary) font-medium">Swedish · English · Punjabi · Hindi</p>
              <p className="text-(--text-muted) text-sm">Fluent in Swedish and English</p>
            </div>
